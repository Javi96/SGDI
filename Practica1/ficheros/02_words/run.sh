...
HADOOP_DIR=/usr/local/hadoop # Directorio donde está Hadoop
...
javac ${CLASS_NAME}.java -cp ${HADOOP_DIR}/share/hadoop/common/hadoop-common-2.8.5.jar:${HADOOP_DIR}/share/hadoop/mapreduce/hadoop-mapreduce-client-core-2.8.5.jar:${HADOOP_DIR}/share/hadoop/common/lib/commons-cli-1.2.jar
